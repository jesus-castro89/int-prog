...
public static void playLevel() {
    ...
    String currentChallenge = challenges[challengeIndex];
    String correctAnswer = answers[challengeIndex];
    // Solicitar la respuesta del jugador
    String playerResponse = InputHelper.getStringInput(currentChallenge, "Reto Numérico");
    // Verificar la respuesta y actualizar la energía
    if (playerResponse.equalsIgnoreCase(correctAnswer)) {
        playerEnergy += 10;
        String message = "¡Correcto! Has ganado 10 puntos de energía.\nEnergía actual: " + playerEnergy;
        InputHelper.showInfoDialog(message, "Respuesta Correcta");
    } else {
        playerEnergy -= 15;
        String message = "Incorrecto. La respuesta correcta era: " + correctAnswer +
                "\nHas perdido 15 puntos de energía.\nEnergía actual: " + playerEnergy;
        InputHelper.showWarningDialog(message, "Respuesta Incorrecta");
    }
